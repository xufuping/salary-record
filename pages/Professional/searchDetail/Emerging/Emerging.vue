<template>
	<view class="professionPage">
		...
		<view class="content_more">
			...
			<view class="more_list">
				...
				<view class="input_salary">
					...
					<view class="input_salary_suffix">
						...
						<image class="suffix_image" src="../../../../static/img/professionalDetail/Polygon 3.png"></image>
					</view>
				</view>
			</view>
			...
			<view class="content_table">
				...
				<view class="table_sel_list">
					<view v-for="item in selSortTypeItem" :key="index" class="sel_item" :class="{seled_item:tabTarget.order===item.order}" @click="changeTabTarget(item.order)">{{item.sortType}}</view>
				</view>
		...
		<view class="bottom_tabelbar">
			...
			<view class="tabelbar_item" :class="seledType.type" @click="changePage(2)" >灵活职业</view>
		</view>
